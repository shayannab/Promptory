...
import SparkLogo from '../assets/SparkLogo';
...
function Navbar() {
  ...
  return (
    <nav className="sticky top-0 left-0 right-0 z-50 bg-white/80 dark:bg-black/30 backdrop-blur-xl shadow-lg border-b border-white/10 transition-all duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 py-4 flex justify-between items-center">
        <Link to="/" className="flex items-center space-x-4 group">
          ...
          <h1 className="text-2xl font-heading font-extrabold tracking-tight text-zinc-800 dark:bg-gradient-to-r dark:from-white dark:via-blue-100 dark:to-cyan-100 dark:bg-clip-text dark:text-transparent">
            Promptory
          </h1>
        </Link>
        ...
        <div className="hidden md:flex items-center space-x-8">
          ...
          <button
            onClick={toggleTheme}
            className="p-2 rounded-full bg-glass dark:bg-white/10 hover:bg-white/20 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-blue-500/50 group relative"
            aria-label="Toggle dark mode"
          >
            {/* Framer Motion ready sun/moon icon, placeholder for now */}
            {isDark ? (
              <svg className="w-6 h-6 text-yellow-400 group-hover:scale-110 transition-transform duration-200" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M10 2a1 1 0 011 1v1a1 1 0 11-2 0V3a1 1 0 011-1zm4 8a4 4 0 11-8 0 4 4 0 018 0zm-.464 4.95l.707.707a1 1 0 001.414-1.414l-.707-.707a1 1 0 00-1.414 1.414zm2.12-10.607a1 1 0 010 1.414l-.706.707a1 1 0 11-1.414-1.414l.707-.707a1 1 0 011.414 0zM17 11a1 1 0 100-2h-1a1 1 0 100 2h1zm-7 4a1 1 0 011 1v1a1 1 0 11-2 0v-1a1 1 0 011-1zM5.05 6.464A1 1 0 106.465 5.05l-.708-.707a1 1 0 00-1.414 1.414l.707.707zm1.414 8.486l-.707.707a1 1 0 01-1.414-1.414l.707-.707a1 1 0 011.414 1.414zM4 11a1 1 0 100-2H3a1 1 0 000 2h1z" clipRule="evenodd" />
              </svg>
            ) : (
              <svg className="w-6 h-6 text-blue-500 group-hover:scale-110 transition-transform duration-200" fill="currentColor" viewBox="0 0 20 20">
                <path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z" />
              </svg>
            )}
            {/* Sparkle effect can be added here with Framer Motion */}
          </button>
          ...
          {user && (
            <>
              ...
              <motion.button
                whileTap={{ scale: 0.93 }}
                className="bg-gradient-to-r from-emerald-400 via-blue-500 to-purple-500 text-white px-6 py-3 rounded-xl font-bold shadow-lg transition-all duration-300 hover:shadow-[0_0_20px_#10B98155] hover:scale-105 focus:outline-none focus:ring-2 focus:ring-emerald-400/50"
